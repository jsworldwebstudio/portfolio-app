          ...
          <List classes={{ padding: classes.aboutListPadding }}>
            ...
            <ListItem classes={{ gutters: classes.aboutLisItemGutters }}>
              ...
              <ListItemText
                ...
                secondary={<Typography variant="body2" color="textSecondary">Full Development of Logos, Mobile Apps and Websites using leading-edge software and application development frameworks (Sketch, Ionic v3 and Angular v2+ specifically). If you need existing maintenance or upgrades using other technologies, that can be discussed as well.</Typography>}
              />
            </ListItem>
            <ListItem classes={{ gutters: classes.aboutLisItemGutters }}>
              <ListItemIcon classes={{ root: classes.aboutIcon }}>
